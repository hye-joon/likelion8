...
urlpatterns = [
    ...
    path('crudapp/postupdate/<int:crud_id>', crudapp.views.postupdate, name='postupdate'),
    path('crudapp/postdelete/<int:crud_id>', crudapp.views.postdelete, name='postdelete'),
]
